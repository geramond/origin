...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/gdbm/. ext/objspace/. ext/psych/. ext/stringio/. \
	     ext/fcntl/. ext/rubyvm/. ext/coverage/. ext/etc/. \
	     ext/openssl/. ext/continuation/. ext/json/. \
	     ext/json/generator/. ext/json/parser/. ext/fiddle/. \
	     ext/readline/. ext/socket/. ext/cgi/escape/. ext/syslog/. \
	     ext/nkf/. ext/bigdecimal/. ext/bigdecimal/util/. \
	     ext/ripper/. ext/racc/cparse/. ext/io/console/. \
	     ext/io/nonblock/. ext/io/wait/. \
	     ...
	     ext/-test-/vm/. ext/-test-/wait_for_single_fd/. ext/dbm/. \
	     ext/fiber/. ext/sdbm/. ext/date/. ext/rbconfig/sizeof/. \
	     ext/pty/. ext/strscan/. ext/pathname/. ext/digest/. \
